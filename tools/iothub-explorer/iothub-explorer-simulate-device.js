...
program
  ...
  .description('Simulates a device.')
  ...
  .option('--settle <complete|abandon|reject>', 'Indicates how the received C2D messages should be settled (defaults to \'complete\')', verifySettle)
