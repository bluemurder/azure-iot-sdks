...
program
  ...
  .option('-a, --auto', 'Creates a device with an auto-generated device id')
  ...
  .option('-k1, --key1 <key>', 'Specifies the primary key for newly created device.')
  .option('-k2, --key2 <key>', 'Specifies the secondary key for newly created device.')
  .option('-r, --raw', 'Use this flag to return raw JSON instead of pretty-printed output.')
  .option('-x, --x509', 'Generates an x509 certificate to authenticate the device.')
  .option('-dv, --daysValid', 'Number of days the x509 certificate should be valid for')
  .option('-t1, --thumbprint1 <thumbprint>', 'Specifies the primary thumbprint of the x509 certificate.')
  .option('-t2, --thumbprint2 <thumbprint>', 'Specifies the secondary thumbprint of the x509 certificate.')
  .parse(process.argv);
